 ...
 *    1. Performs theme name text replacements
 *    2. Copies bootstrap from Node Modules directory
 *    3. Initializes languages file
 */
...
gulp.task(
	'default',
	gulp.parallel( 'styles', 'adminStyles', 'editorStyles', 'vendorsJS', 'customJS', 'adminJS', 'editorJS', 'customizerJS', 'images', browsersync, () => {
		gulp.watch( config.watchPhp, reload ); // Reload on PHP file changes.
		gulp.watch( config.watchStyles, gulp.parallel( 'styles', 'adminStyles', 'editorStyles' ) ); // Reload on SCSS file changes.
		gulp.watch( config.watchJsVendor, gulp.series( 'vendorsJS', reload ) ); // Reload on vendorsJS file changes.
		gulp.watch( config.watchJsCustom, gulp.series( 'customJS', reload ) ); // Reload on customJS file changes.
		gulp.watch( config.watchJsAdmin, gulp.series( 'adminJS', reload ) ); // Reload on customJS file changes.
