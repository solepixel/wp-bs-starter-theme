<?php
/**
 * Plugin Name: Theme Bootstrap Comments
...
if ( class_exists( 'Theme_Bootstrap_Comments_Walker' ) ) :
	return;
endif;

/**
 * Main Theme Bootstrap Comments Walker Class
 *
 * @since 0.1.0
 */
class Theme_Bootstrap_Comments_Walker extends Walker_Comment {
	...
	protected function html5_comment( $comment, $depth, $args, $is_parent = false ) {
		...
		$comment_classes = apply_filters( 'theme_bootstrap_comment_class', $comment_classes, $comment, $depth, $args );
				...
				<div class="flex-grow-1 ms-3">
					...
					<footer class="comment-meta">
						<div class="comment-author vcard">
							<?php printf( esc_html__( '%s <span class="says visually-hidden">says:</span>', '_s' ), sprintf( '<b class="media-heading fn">%s</b>', get_comment_author_link( $comment ) ) ); ?>
						</div><!-- /.comment-author -->
						...
						<div class="comment-metadata">
							<a href="<?php echo esc_url( get_comment_link( $comment, $args ) ); ?>">
								<time datetime="<?php comment_time( 'c' ); ?>">
									...
									printf( esc_html__( '%1$s at %2$s', '_s' ), get_comment_date( '', $comment ), get_comment_time() );
									?>
								</time>
							</a>
						...
						<?php if ( 0 === intval( $comment->comment_approved ) ) : ?>
							<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', '_s' ); ?></p>
						<?php endif; ?>
					</footer><!-- /.comment-meta -->
