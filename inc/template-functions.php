 ...
 *
 * @param int $length Excpert length.
 */
...
function _s_comment_form_fields( $fields ) {
	...
	$fields['author']  = '<div class="mb-3 comment-form-author"><label for="author">' . esc_html__( 'Name', '_s' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label>
		<input class="form-control" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></div>';
	$fields['email']   = '<div class="mb-3 comment-form-email"><label for="email">' . esc_html__( 'Email', '_s' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label>
		<input class="form-control" id="email" name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></div>';
	$fields['url']     = '<div class="mb-3 comment-form-url"><label for="url">' . esc_html__( 'Website', '_s' ) . '</label> 
	...
	$fields['cookies'] = '<div class=" mb-3 comment-form-cookies-consent form-check"><input id="wp-comment-cookies-consent" class="form-check-input" name="wp-comment-cookies-consent" type="checkbox" value="yes"' . $consent . ' />
		<label class="form-check-label" for="wp-comment-cookies-consent">' . esc_html__( 'Save my name, email, and website in this browser for the next time I comment.', '_s' ) . '</label></div>';
